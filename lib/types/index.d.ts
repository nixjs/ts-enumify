export declare namespace Enumify {
     ...
     */
    const generate: <T extends readonly any[], K extends ValuesOfArray<T>>(arr: T, allowNumber?: boolean, start?: number, convention?: number) => Readonly<ToObj<K>>;
}
